export = {
    GetProduct: `query GetProduct($id: String!, $currencyCode: CurrencyCode, $countryCode: String!, $marketName: String) {
        product(id: $id) {
          id
          listingType
    ...
    FetchRelatedProducts: `query FetchRelatedProducts($productId: String!, $countryCode: String!, $currencyCode: CurrencyCode, $type: RelatedProductsType, $marketName: String) {
